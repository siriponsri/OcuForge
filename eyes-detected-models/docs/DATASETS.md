...
- **MMRDR UWF (`mmrdr_uwf_v1`)** is the reviewed global source: Figshare record version 2,
...
- **IDRiD (`idrid_v1`)** is the selected ROI source: 516 CFP images, released 413/103 split, and localized
...
not selected for the first frozen set. No registry entry downloads data; a future GPU run must download directly
from the official/public source to the configured data root only after the relevant gate passes.
...
downloaded bytes. No hospital data was inspected in this R0/R1-ready change.
