...
Configuration and examples live in this package; labeler code depends on the shared contracts package and never on
the model implementation. See the [V3 system architecture](../docs/diagrams/ocuforge-system-architecture.svg).
