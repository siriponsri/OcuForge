...
The current gates are `R0_V3=PASS`, `R1_P0_ACQUISITION_PREFLIGHT=BLOCKED` pending byte-dependent checks, and R1
C0/C1/C2 is `READY_NOT_EXECUTED`. This document authorizes the owner-approved public RunPod runtime for R1-P0
